...
https://drive.google.com/file/d/1gae-AXkgCj9liuEAHNmypdjOKrKkWJYN/view?usp=sharing <br /> put custom.weights file inside the data folder and the checkpoints/ folder in the main branch of the of the project (at the same level of data folder or core folder)
